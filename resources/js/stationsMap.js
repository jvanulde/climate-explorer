...
(function (root, factory) {
  ...
  $.widget('ce.stationsMap', {
    ...
    _initMap: function _initMap() {
      ...
      var mapCenter = this.options.lat && this.options.lon ? [this.options.lon, this.options.lat] : [-123, 42];
      var mapZoom = this.options.zoom ? this.options.zoom : 8;
        ...
        if (this.view.extent) {
          ...
          if (this.map.layers.items[0]) {
            ...
            if (typeof ArcgisToGeojsonUtils !== "undefined" && typeof turf !== "undefined") {
              var LayerGeoJSON = ArcgisToGeojsonUtils.arcgisToGeoJSON(firstLayerJSON, "ObjectID");
              ...
              var bbox = [xymin[0], xymin[1], xymax[0], xymax[1]];
    ...
    _updateStationSelect: function _updateStationSelect(currentstations) {
      ...
      var currentstationsSorted = currentstations.features.sort(function (a, b) {
      ...
      var stationLi = '';
      currentstationsSorted.forEach(function (station) {
        if (_this2.options.mode === 'high_tide_flooding') {
      ...
      var stationsElem = document.querySelector('#stations-select-wrapper .select-options');
      if (stationsElem) {
